...
namespace DatingHemsida_Grupp_9.Controllers
{
    ...
    public class FriendController : Controller
    {
        ...
        public ActionResult Index()
        {
             ...
             */
            var senderList = _DatingContext.FriendRequests.Where(x => x.FriendSenderId.Equals(id))
                .Where(x => x.Accepted == true).Select(x => x.FriendReceiverId).ToList();
            var receiverList = _DatingContext.FriendRequests.Where(x => x.FriendReceiverId.Equals(id))
                .Where(x => x.Accepted == true).Select(x => x.FriendSenderId).ToList();
        ...
        public ActionResult AcceptDecline(int FriendId, string AcceptDecline)
        {
            ...
            (x => x.FriendReceiverId == UserId && x.FriendSenderId == FriendId);
        ...
        public ActionResult AddFriend(int receiverId)
        {
            ...
            _DatingContext.SaveChanges();
            return RedirectToAction("Index", "Wall", new { profileId = receiverId }); ;
        }
        ...
        public ActionResult RemoveFriend(int FriendId)
        {
            ...
            (x => x.FriendReceiverId == UserId && x.FriendSenderId == FriendId && x.Accepted == true);
            if (friendFind != null)
            {
